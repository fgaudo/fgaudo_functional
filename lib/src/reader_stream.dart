...
final class ReaderStream<ENV, A> {
  ...
  Stream<A> Function(ENV) get asFunction => _f;
}
...
ReaderStream<R, Never> Do<R>() => ReaderStream((_) => Stream.empty());
